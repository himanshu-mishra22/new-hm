    ...
    return (
        ...
        <div className="ManagerLoginBoxPAGE" id="ManagerLoginBoxPAGE">
            ...
            <div className="ManagerLoginBox">
                ...
                <Link className="ManagerLoginBox-a ManagerLoginBoxBTN" to="/empManager/view" data-bs-toggle="tooltip" data-bs-placement="right" title="View Employees"
><svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
  ...
  <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
                ...
                <Link className="ManagerLoginBox-b ManagerLoginBoxBTN" to="/empManager/add" data-bs-toggle="tooltip" data-bs-placement="right" title="Add Employee"
><svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
  ...
  <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
                ...
                <Link className="ManagerLoginBox-c ManagerLoginBoxBTN" to="/paidsalManager/view" data-bs-toggle="tooltip" data-bs-placement="right" title="View Paid Salaries"
><svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-cash-stack" viewBox="0 0 16 16">
  ...
  <path d="M0 5a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V5zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V7a2 2 0 0 1-2-2H3z"/>
                ...
                <Link className="ManagerLoginBox-d ManagerLoginBoxBTN" to="/paidsalManager/add" data-bs-toggle="tooltip" data-bs-placement="right" title="Add Salary"
